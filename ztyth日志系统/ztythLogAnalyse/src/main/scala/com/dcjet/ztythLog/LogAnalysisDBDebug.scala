...
object LogAnalysisDBDebug {
  ...
  def main(args: Array[String]): Unit = {
    ...
    var iConfig:InnerConfig = InnerConfig(false,true,true,true)

    //var debugLogPath = "/data/logHDFS/apollo/test.log"
    var debugLogPath = "/data/logHDFS/ztyth_apollo_180/2018-09-25.log"

    val files:List[String] = getPendingFilePath(spark,"ztyth_apollo_179#ztyth_apollo_180","2018-10-18",1)

    var logPath : String = files.reduce(_+"," + _)
