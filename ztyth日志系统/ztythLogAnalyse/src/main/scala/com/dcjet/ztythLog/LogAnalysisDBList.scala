...
/**
  * 提交脚本
  * spark2-submit --class com.dcjet.ztythLog.LogAnalysisDB --master yarn --deploy-mode cluster --jars /home/sparkjars/fastjson-1.2.47.jar /data/workspace/spark/ztythloganalyse.jar debug /data/logHDFS/apollo/2018-08-08.log
  */
object LogAnalysisDBList {
  ...
  /**
    ...
    * @return
    */
  def getPendingFilePath(spark:SparkSession,serverList:String,beginDate:String, dayCount:Int) : List[String] = {
  ...
  def main(args: Array[String]): Unit = {
    ...
    var iConfig:InnerConfig = InnerConfig(false,true,false,true)

    //var debugLogPath = "/data/logHDFS/apollo/test.log"
    var debugLogPath = "/data/logHDFS/ztyth_apollo_179/2018-10-15.log"
    ...
    if(args.length>0 && args(0) == "debug") {
      ...
      serverList = args(2)
      beginDate = args(3)
      daysCount = Integer.parseInt(args(4))
    }

    import org.joda.time._
    import spark.implicits._
    //创建对象
    val files:List[String] = getPendingFilePath(spark,serverList,beginDate,daysCount)
    ...
    var originalSource = originLines.map(line => {
